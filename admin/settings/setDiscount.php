            ...
            <div class="col-md-6">
              ...
              <input type="hidden" name="PROID" value="<?php  echo $result->PROID; ?>">
                ...
                <ul>
                    ...
                    <li>Price - &#8369;<?php echo number_format($result->PROPRICE,2); ?></li>
                    <li>Discount - <?php echo $result->PRODISCOUNT; ?>%  </li> 
                    <li>Discounted Price - &#8369;<?php echo number_format($result->PRODISPRICE,2); ?> </li> 
                </ul>
          ...
          <div class="col-md-6">
             <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text"  class="form-control" name="PRODISPRICE" id="PRODISPRICE" placeHolder="0.00" readonly="true">
                </div>
                <!-- /.input group -->
              </div>
