                                ...
                                <form class="form-inline pull-right" action="index.php" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control date start input-lg" size="20" type="date"
                                            ...
                                            Placeholder="Check In" name="start" id="from" data-date=""
                                            data-date-format="yyyy-mm-dd" data-link-field="any"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control date end input-lg" size="20" type="date"
                                            ...
                                            name="end" id="end" data-date="" data-date-format="yyyy-mm-dd"
...
?>
                                    ...
                                    <table>
                                        ...
                                        <tfoot style="margin-right:10%">
                                            ...
                                            <tr>
                                                <h4 align="right"> Overall Price : &#8369
                                                    <?php echo isset( $overall) ? $overall : 0; ?>
                                                </h4>
                                            </tr>
                                ...
                                <button onclick="tablePrint();" class="btn btn_fixnmix"><span
