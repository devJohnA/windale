...
switch ($action) {
	...
	function doInsert(){
		...
		if ($_POST['CUSUNAME'] == "" OR $_POST['FNAME'] == "" OR $_POST['LNAME'] == "" OR $_POST['CUSPASS'] == "") {
			$messageStats = false;
			...
			message("New [". $_POST['CUSUNAME'] ."] created successfully!", "success");
			redirect("index.php");
	...
	if(isset($_POST['save'])){
			...
			$customer->update($_POST['CUSTOMERID']);
			  ...
			  message("[". $_POST['CUSUNAME'] ."] has been updated!", "success");
			redirect("index.php");
		}
	}
	...
	function doDelete(){
		...
		// for($i=0;$i<$key;$i++){
			...
			message("Customer already Deleted!","info");
			redirect('index.php');
		// }
		// }
